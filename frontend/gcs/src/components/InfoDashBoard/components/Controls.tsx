            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                ...
                >
                    <Box className="flex items-center mb-2">
                        <StopIcon sx={{ color: trackingData.isTracking ? '#ef4444' : '#6b7280', mr: 1.5, fontSize: 20 }} />
                    ...
                    <Typography variant="caption" className="text-neutral-300 mb-3 block">
                        {trackingData.isTracking ? 'Stop following the current target' : 'No target being followed'}
                    </Typography>
                    <Button
                        ...
                        fullWidth
                        sx={{
                            backgroundColor: trackingData.isTracking ? '#ef4444' : '#374151',
                            color: 'white',
                            '&:hover': {
                                backgroundColor: trackingData.isTracking ? '#dc2626' : '#374151',
                            },
                            '&:disabled': {
                    ...
                    >
                        {trackingData.isTracking ? 'Stop Following' : 'Not Following'}
                    </Button>
                </Paper>
